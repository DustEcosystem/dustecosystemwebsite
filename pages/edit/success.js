    ...
    return (
        <Layout showSubmitProjectBtn={false} showFooter={false} title={`${projectName} Success`}>
            ...
            <div className="flex flex-col justify-center items-center min-h-[35rem] md:min-h-[30rem] px-5 gap-5">
                ...
                <h4 className="text-white text-4xl leading-[110%] -tracking-[1px] font-bold md:w-[50%] text-center selectionColor">Congrats,  {projectName} Information Updated Successfully</h4>
