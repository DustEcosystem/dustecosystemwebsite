...
export async function getServerSideProps(context) {
    let resDustPrice = await fetch('https://api.coingecko.com/api/v3/coins/dust-protocol?localization=false')
    resDustPrice = await resDustPrice.json()
    return {
        props: {
            dustPrice: resDustPrice.market_data.current_price.usd,
        }
    }
}
