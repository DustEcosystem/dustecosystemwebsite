...
const SubmitProject = ({providers}) => {
    ...
    if(!session) return <Login providers={providers} callBackURL={"/submit-project"}/>
    ...
    const handleSubmit = async () => {
        ...
        const docRef = await addDoc(collection(db,"projectsDatabase"),{
            ...projectInfo,
        ...
        router.push(`/submit-project/success?projectName=${projectInfo.projectName.replaceAll(" ","+")}&slug=${projectInfo.projectName.replaceAll(" ","").toLowerCase()}`)
        setLoading(false)
    }

    return (
        <Layout showSubmitProjectBtn={false} showFooter={false} title={"Submit Project"}>
            <div className="flex flex-col px-4 pb-16 sm:px-8 lg:px-28 xl:px-52 text-white gap-8">
                <div className="flex items-center justify-between">
                    <h2 className="text-lg md:text-3xl text-[#90B578] fontFamily selectionColor">Submit New Project</h2>
                    <button
                        ...
                        <div className="flex justify-between">
                            ...
                            {currentStep < 5 ? (
                                ...
                                >
                                    ...
                                    <p className="text-base md:text-lg">Submit Project</p> 
                                </button>
                            )}
                        </div>
                    </div>
